    ...
    >
      ...
      >
        <article className="  flex w-full justify-end ">
          <p className="max-w-[25rem] rounded-lg border border-primary-light bg-primary-dark p-4 text-[0.6rem] text-primary-light dark:border-primary-dark dark:bg-primary-light dark:text-primary-dark xl:max-w-[35rem] xl:text-xs">
            In the ever-evolving landscape of blockchain and cryptocurrency,
            efficiency, convenience, and innovation are paramount.
          </p>
        </article>
        <article className="flex w-full justify-end  ">
          <p className="max-w-[15rem] rounded-lg border border-primary-light bg-primary-dark p-4 text-[0.6rem] text-primary-light dark:border-primary-dark dark:bg-primary-light dark:text-primary-dark xl:max-w-[25rem] xl:text-xs">
            Aikisend is a groundbreaking solution that re-imagines the way
            digital assets are transferred.
          </p>
        </article>
        <article className="  flex w-full justify-end">
          <p className="max-w-[30rem] rounded-lg border border-primary-light bg-primary-dark p-4 text-[0.6rem] text-primary-light dark:border-primary-dark dark:bg-primary-light dark:text-primary-dark xl:max-w-[40rem] xl:text-xs">
